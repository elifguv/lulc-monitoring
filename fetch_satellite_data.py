...
# Point the library to the new Copernicus European servers
...
# Scale the width down to 2500 pixels.
if raw_size[0] > 2500:
    ...
    request = SentinelHubRequest(
        ...
        input_data=[
            SentinelHubRequest.input_data(
                data_collection=DataCollection.SENTINEL2_L1C.define_from("s2l1c_cdse", service_url=config.sh_base_url),
                time_interval=time_interval,
                maxcc=0.05, # Max cloud coverage of 5%
...
if __name__ == "__main__":
    ...
    img_2024 = fetch_bursa_image(2025) 
    
    # Preview of the downloaded data
    if img_2020 is not None and img_2024 is not None:
